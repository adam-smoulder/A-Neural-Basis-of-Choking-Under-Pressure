%ABANDONED - USED AS SCRIPT!


% SAME AS inferFALatents.m BUT faMdl IS A int8 MATRIX WITH -1s INSTEAD OF
% NaNs!
%
% Adam Smoulder, 6/21/19
%
%
% Given an FA model and observed data, possibly with missing values, this
% function will infer the posterior distribution over latent states. 
%
...
%
function [postMeans, postCovInds, postCovs] = inferFALatentsLowMem(faMdl, x, varargin)
...
% Estimate latents
latentStr = fastFAWithMissingValuesEStep(xCtrBlocked, faMdl.C, faMdl.psi);
