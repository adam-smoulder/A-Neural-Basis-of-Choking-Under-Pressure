function [binnedData] = getSingleDataBinFromSpikeMatrix(trialData,taskInfo,binSize,event,delay)
...
nunits = size(taskInfo.stitchingModel.C,1);
...
for i = 1:length(trialData)
    ...
    if ~isnan(eventTime)
        ...
        binnedData(i,taskInfo.unitIDs{trialData(i).day}) = mean(trialData(i).neuralData.spikeMatrix(:,startInd:endInd),2)*1000;
    end
end; clear i
end
